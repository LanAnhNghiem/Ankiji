...
public class KanjiSetAdapter extends RecyclerView.Adapter<KanjiSetAdapter.KanjiSetHolder> {
    private List<KanjiSet> mMojiSet = new ArrayList<>();
    private Context mContext;
    private RemoveDataCommunicator mCommunicator;
    private OnBoomMenuItemClicked mListener;
    public KanjiSetAdapter(List<KanjiSet> list, Context context, RemoveDataCommunicator communicator) {
        this.mMojiSet = list;
    ...
    @Override
    public KanjiSetHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_recycler_item,
                parent, false);
        return new KanjiSetHolder(itemView);
    }

    @Override
    public void onBindViewHolder(KanjiSetHolder holder, final int position) {
    ...
    public class KanjiSetHolder extends RecyclerView.ViewHolder {
        TextView tvTitle;
        TextView tvDateTime;
        ImageButton btnDeleteItem;
        BoomMenuButton bmb;
        public KanjiSetHolder(View itemView) {
            super(itemView);
    ...
    void addBuilder(final KanjiSetHolder viewHolder, int stringIndex) {
