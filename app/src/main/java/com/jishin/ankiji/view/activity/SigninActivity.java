...
//            Toast.makeText(SigninActivity.this, "Welcome " + mAuth.getCurrentUser().getEmail(), Toast.LENGTH_LONG).show();
    ...
    private void getControls() {
        ...
        txtCreateAcount = findViewById(R.id.tv_create_an_account);
        txtForgotPass = findViewById(R.id.tv_forgot_password);
...
//                    Toast.makeText(SigninActivity.this, " non currentUser", Toast.LENGTH_LONG).show();
//                }
//            }
//        };
//        if (mAuth != null) {
